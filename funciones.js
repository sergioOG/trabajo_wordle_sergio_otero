 ...
 */
 ...
 var listaPalabras = ['ajito', 'ayuda', 'adobo', 'adora', 'apilo', 'añejo', 'fumar', 'conos', 'mesas', 'tomar','messi','salah'];
 ...
 **************************************************************/
 ...
 function haGanado() {
     ...
     if (palabra == palabraBuscada){
         let mensajeGanador = '<h2 class="alert alert-success text-center" role="alert">Ganar por mucho o por poco, ganar es ganar';
